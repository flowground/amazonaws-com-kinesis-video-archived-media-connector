# ![LOGO](logo.png) Amazon Kinesis Video Streams Archived Media **flow**ground Connector

## Description

A generated **flow**ground connector for the Amazon Kinesis Video Streams Archived Media API (version 2017-09-30).

Generated from: https://api.apis.guru/v2/specs/amazonaws.com/kinesis-video-archived-media/2017-09-30/swagger.json<br/>
...
**flow**ground :- Telekom iPaaS / amazonaws-com-kinesis-video-archived-media-connector<br/>
